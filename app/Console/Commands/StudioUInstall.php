...
class StudioUInstall extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'Studio:install {--force : Do not ask for User confirmation}';
     ...
     * @var string
     */
    protected $description = 'Install dummy Data for Portfolio  App';
