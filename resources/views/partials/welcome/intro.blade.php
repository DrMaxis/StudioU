    ...
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            <div class="intro-secton" {{-- style="background: rgba(0,0,0,0) url({{asset('assets/imgs/overlays/newtv2-1.png')}}) no-repeat scroll center center / cover" --}}>
                ...
                <img style="width:100%;" src="{{asset('assets/imgs/overlays/newtv2-1.png')}}" alt="">
                <div class="content clearfix">
		
                        <header class="site clearfix">
                        <div class="col one">
                            <img src="http://www.mackrichardson.com/dev/pixelspace/remote-images/logo-v.jpg" alt="591 Industries" width="740" height="729" id="logo-v" />
                        </div>
                            <div class="col two">
